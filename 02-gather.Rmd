...
untidy_flyers <- read_csv("https://raw.githubusercontent.com/fivethirtyeight/data/master/flying-etiquette-survey/flying-etiquette.csv") %>% 
...
ggplot(rude_summarized, aes(x = label, y = rude_prop)) +
...
In the next lesson [03-spread](03-spread.html) I show to untidy data, using `spread()` from the tidyr package. This might be useful at the end of an analysis, for preparing figures or tables.
