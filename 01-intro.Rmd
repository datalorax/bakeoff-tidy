...
I will give you a concrete example of some untidy data I created from [this data from "The Great British Bake Off"](https://github.com/apreshill/bakeoff).
...
How well does your approach scale if there were many more series or if I provided you with updated data that includes all the types of possible bakes (custards, buns, etc.)?
